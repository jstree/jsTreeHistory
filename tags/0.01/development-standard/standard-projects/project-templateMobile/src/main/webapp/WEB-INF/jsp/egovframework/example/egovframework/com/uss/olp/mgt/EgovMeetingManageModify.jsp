...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
  ...
  <DIV style="padding:0px 0px 0px 0px;margin:0px 15px 0px 0px;border:solid 0px;"><label for="mngtDeptNm">주관부서</label></DIV></th>
    <td>
      ...
      <img src="<c:url value='/images/egovframework/com/cmm/search2.gif'/>" align="middle" style="border:0px" alt="주관부서 찾기버튼" title="주관부서 찾기버튼">
      </a>
  ...
  <DIV style="padding:0px 0px 0px 0px;margin:0px 15px 0px 0px;border:solid 0px;"><label for="mnaerNm">주관자명</label></DIV></th>
    <td>
      ...
      <img src="<c:url value='/images/egovframework/com/cmm/search2.gif'/>" align="middle" style="border:0px" alt="주관자ID 찾기버튼" title="주관자ID 찾기 버튼">
      </a>
  ...
  <DIV style="padding:0px 0px 0px 0px;margin:0px 15px 0px 0px;border:solid 0px;"><label for="mnaerDeptNm">주관자부서</label></DIV></th>
    <td>
      ...
      <img src="<c:url value='/images/egovframework/com/cmm/search2.gif'/>" align="middle" style="border:0px" alt="주관자부서 찾기버튼" title="주관자부서 찾기 버튼">
      </a>

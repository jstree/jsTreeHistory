...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="/images/egovframework/com/uss/ion/ctn/icon/tit_icon.gif" width="9" height="9" hspace="3" style="vertical-align: middle" alt="">&nbsp;경조 신청자</td>
 </tr>
</table>
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="소속정보" >
<caption>소속정보</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="usid">경조신청자</label><img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>          
    <td width="30%"  >
	    ...
	    <img src="<c:url value='/images/egovframework/com/cmm/search2.gif' />" alt="검색"  width="15" height="15">
	    </a></span>
    </td>
    <th width="20%" height="23" class="required_text" scope="row"><label for="usOrgnztNm">소속</label><img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>          
...
<caption>경조신청</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="ctsnnNm">경조명</label><img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3"><form:input  path="ctsnnNm" title="경조명" /></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="ctsnnCd">경조구분</label><img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%">
      <form:select path="ctsnnCd" title="경조구분">
	      <form:options items="${ctsnnCodeList}" itemValue="code" itemLabel="codeNm"/>
      </form:select>
    </td>
    <th width="20%" height="23" class="required_text" scope="row"><label for="occrrDe">발생일</label><img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="trgterNm">대상자명</label><img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3"><form:input  path="trgterNm" title="대상자명"/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="relate">관계</label><img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%">
      <form:select path="relate" title="관계">
	      <form:options items="${relateCodeList}" itemValue="code" itemLabel="codeNm"/>
      </form:select>
    </td>
    <th width="20%" height="23" class="required_text" scope="row"><label for="brth">생년월일</label><img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="remark">비고</label><img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>          
    <td colspan="3">

...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="행사/이벤트/캠페인 정보, 성별, 외부인사명, 생년월일, 직업유형, 소속기관, 전화번호, 이메일주소 입니다">
  <tr>
    ...
    <td width="80%" nowrap>
      ...
      <img src="<c:url value='/images/egovframework/com/cmm/img/search2.gif'/>" align="middle" style="border:0px" alt="행사/이벤트/캠페인 정보" title="행사/이벤트/캠페인 정보">
      </a>
...
<!-- 
	 ...
	 <td background="<c:url value='/images/egovframework/com/cmm/button/bu2_bg.gif'/>" class="text_left" nowrap><a href="JavaScript:fn_egov_save_TnextrlHrInfo();"><spring:message code="button.save"/></a>
  	 </td>

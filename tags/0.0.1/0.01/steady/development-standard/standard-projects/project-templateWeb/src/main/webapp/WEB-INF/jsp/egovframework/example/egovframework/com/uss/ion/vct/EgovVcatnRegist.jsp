...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="/images/egovframework/com/uss/ion/vct/icon/tit_icon.gif" width="9" height="9" hspace="3"  style="vertical-align: middle" alt="">&nbsp;휴가 신청자</td>
 </tr>
</table>
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="신청자 정보" >
<caption>신청자 정보</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">신청자<img src="/images/egovframework/com/uss/ion/vct/icon/no_required.gif" width="15" height="15" alt=""></th>          
    <td width="30%" nowrap ><c:out value='${vcatnManageVO.applcntNm}'/></td>
    <th width="20%" height="23" class="required_text"  scope="row">소속<img src="/images/egovframework/com/uss/ion/vct/icon/no_required.gif" width="15" height="15" alt=""></th>          
...
<caption>휴가관리 등록</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="vcatnSe">휴가구분</label><img src="/images/egovframework/com/uss/ion/vct/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="bgnde">시작일자</label><img src="/images/egovframework/com/uss/ion/vct/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%">
    ...
    <th width="20%" height="23" class="required_text" scope="row"><span id="nameSpan"><label for="endde">종료일자</label></span><img src="/images/egovframework/com/uss/ion/vct/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="vcatnResn">휴가사유</label><img src="/images/egovframework/com/uss/ion/vct/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3">

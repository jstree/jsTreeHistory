...
public class EgovMultimediaServiceImpl extends AbstractServiceImpl implements
    ...
    public Multimedia selectMultimedia(Multimedia multimedia) throws Exception {
        Multimedia ret =
            (Multimedia) multimediaDAO.selectMultimedia(multimedia);
        return ret;
    }
    ...
    public List<MultimediaFileInfo> getMultimediaFileInfoFromXML()
        ...
        List<MultimediaFileInfo> multimediaFileInfoList = new ArrayList();

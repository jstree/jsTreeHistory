...
catch(Exception ex)
{
	...
	System.out.println("HttpService insert error");
}
finally
{
    ...
    out.print("</root>");
    System.out.println("HttpService insert row=" + iResult);
	System.out.println("HttpService insert sql=" + sql);
	System.out.println("HttpService insert execution time: " + (System.currentTimeMillis() - startTime));
	System.out.println("-----------------------------------------------------------------------");
}
%>
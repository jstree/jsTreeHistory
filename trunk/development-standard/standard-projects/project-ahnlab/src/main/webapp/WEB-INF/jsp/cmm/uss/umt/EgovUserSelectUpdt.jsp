                        ...
                        <table>
                            ...
                            <tr>
				                ...
				                <td width="30%" ><label for="areaNo"></label>
				                    ...
				                    - <label for="homemiddleTelno"></label><form:input path="homemiddleTelno" id="homemiddleTelno" cssClass="txaIpt" size="4" maxlength="4" />
				                    - <label for="homeendTelno"></label><form:input path="homeendTelno" id="homeendTelno" cssClass="txaIpt" size="4" maxlength="4" />

...
<!--<![endif]-->
	<head>		
		...
		.header{ width:1180px; height:101px;}
    	...
    	<div class="intro">
    		<div class="leftD">
				...
				<div class="dwrap">
        			...
        			<span class="name">Cha Seungwon</span>
    			</div><!--//dwrap-->
				<div class="infowrap">
    	    ...
    	    <div class="rightD">
    			...
    			<div class="dwrap">
    				<span class="designer">Designer</span>
	    		    <span class="name">Kim hyunjoo</span>
    			</div><!--//dwrap-->
			...
			<div class="leftD">
			    ...
			    <div class="dwrap">
		    		<span class="designer">Designer</span>
        			<span class="name2">An Jaehong</span>
	    		</div><!--//dwrap-->
				<div class="infowrap">
    				<span class="info">Info</span>
        			<ul class="career">
			...
			<div class="rightD">
	    		...
	    		<div class="dwrap">
	    			<span class="designer">Designer</span>
		    	    <span class="name3">Park Haejin</span>
	    		</div><!--//dwrap-->

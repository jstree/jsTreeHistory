...
function fn_egov_save(){
	...
	if(checkValue()){
		if(confirm("현재 프로퍼티 설정으로 신규 생성됩니다.\n저장하시겠습니까?")){
			var options = { 
				   	   success     : responseCtl,
				       url         : "<c:url value='/ole/sms/insert313NewProperty.sms'/>",
				       type        : "post", /* get, post */
		  	...
		  	<div id="datail_table">
				...
				<caption>Property Config New Regist Info</caption>
                  <tr>
                    ...
                    <th scope="row" colspan="2" width="15%"><label for="beanNm">Property File Name</label></th>

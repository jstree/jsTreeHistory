...
$("#demo")
	...
	.jstree({ 
		...
		"json_data" : { 
			...
			"ajax" : {
				...
				"url" : "${pageContext.request.contextPath}/egovframework/com/ext/jstree/strutsiBatis/getChildNode.action",
		...
		"search" : {
			...
			"ajax" : {
				"url" : "${pageContext.request.contextPath}/egovframework/com/ext/jstree/strutsiBatis/searchNode.action",
	...
	.bind("create.jstree", function (e, data) {
		$.post(
			"${pageContext.request.contextPath}/egovframework/com/ext/jstree/strutsiBatis/addNode.action", 
			{ 
	...
	.bind("remove.jstree", function (e, data) {
		data.rslt.obj.each(function () {
			$.ajax({
				async : false,
				type: 'POST',
				url: "${pageContext.request.contextPath}/egovframework/com/ext/jstree/strutsiBatis/removeNode.action",
				data : { 
	...
	.bind("rename.jstree", function (e, data) {
		$.post(
				"${pageContext.request.contextPath}/egovframework/com/ext/jstree/strutsiBatis/alterNode.action", 
			{ 
	...
	.bind("set_type.jstree", function (e, data) {
		$.post(
				"${pageContext.request.contextPath}/egovframework/com/ext/jstree/strutsiBatis/alterNodeType.action", 
			{ 
					"c_id" : data.rslt.obj.attr("id").replace("node_","").replace("copy_",""),
					"c_title" : data.rslt.new_name,
					"c_type" : data.rslt.obj.attr("rel")
	...
	.bind("move_node.jstree", function (e, data) {
		data.rslt.o.each(function (i) {
			$.ajax({
				async : false,
				type: 'POST',
				url: "${pageContext.request.contextPath}/egovframework/com/ext/jstree/strutsiBatis/moveNode.action",
				data : { 

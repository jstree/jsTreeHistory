...
<!--<![endif]-->
	...
	<body id="dongmin-lee" class="template-index" itemscope itemtype="http://schema.org/WebPage">
		...
		<div class="page-border clearfix">
			...
			<main id="template-customer-register-liquid" class="clearfix" role="main">
				<nav>
					<div class="container bm-medium">
						<div class="one-whole">
							<div class="no-display">customers/register</div>
				...
				<div class="container bm-medium">
					<div class="one-whole boxed p-twenty animate-in clearfix" data-anim-type="fade-in" data-anim-delay="0">
						<div class="one-half-percent desktop-tablet omega bm-remove">
							<p>
								Simply fill in all the fields to create your account.<br />
								If you already have an account, you can <a href="/account/login" target="_self">log in here</a>.
							</p>
						</div>
						<div class="one-half-percent desktop-tablet alpha bm-remove last">
							<form accept-charset="UTF-8" action="https://cloudeight-nero.myshopify.com/account" id="create_customer" method="post">
								...
								<input type="text" name="customer[first_name]" id="register-first-name" class="w-full" placeholder="First Name" value="" />
								<input type="text" name="customer[last_name]" id="register-last-name" class="w-full" placeholder="Last Name" value="" />

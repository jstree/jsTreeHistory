...
<!--<![endif]-->
	...
	<body id="dongmin-lee" class="template-index" itemscope itemtype="http://schema.org/WebPage">
		...
		<div class="page-border clearfix">
			...
			<main id="template-blog-liquid" class="clearfix" role="main">
				<nav>
					<div class="container bm-medium">
						<div class="one-whole">
							<div class="no-display">blog</div>
							<div class="text-center">
								...
								<p class="bm-remove">
									...
									&nbsp;/&nbsp;
									Blog - News <small>[ <a href="/blogs/News.atom" target="_blank">RSS</a> ]</small>
								</p>
							</div>
						</div>
					</div>
				...
				<div class="clearfix">
					<div class="container bm-medium">
						<article>
							<div class="one-half article-loop boxed p-twenty odd loop-first  animate-in clearfix" data-anim-type="fade-in" data-anim-delay="0">
								<h3 class="article-loop-title"><a href="/blogs/news/14332611-morocco-a-chaotic-paradise-part-2" target="_self">Morocco - A Chaotic Paradise (Part 2)</a></h3>
								<hr />
								<div class="article-loop-excerpt rte">
									<p><a href="http://cloudeight-nero.myshopify.com/blogs/news/14332611-morocco-a-chaotic-paradise-part-2" title="Morocco - A Chaotic Paradise (Part 2)"><img src="http://cdn.shopify.com/s/files/1/0522/9261/files/tumblr_n5waxesawa1st5lhmo1_1280.jpg?7" class="block" /></a></p>
								</div>
								<hr />
								<p class="article-loop-details bm-remove text-right">
									By <a href="javascript:void();" target="_self" class="tip-t-fade" data-tooltip="<img src='http://www.gravatar.com/avatar/64e8d42afadce7dfcac8031d25707a6b?s=500' alt='Gravatar Image' class='block' style='width: 100px; height: 100px;' />">Joe Mottershaw</a> on <time pubdate datetime="2014-06-03">Jun 03, 2014</time>
									<strong>&nbsp;&bull;&nbsp;</strong> <a href="/blogs/news/14332611-morocco-a-chaotic-paradise-part-2#article-comments" target="_self"><i class="fa fa-comments fa-fw"></i> 2 Comments</a>
								</p>
							</div>
						</article>
						<article>
							<div class="one-half article-loop boxed p-twenty even loop-last last animate-in clearfix" data-anim-type="fade-in" data-anim-delay="200">
								<h3 class="article-loop-title"><a href="/blogs/news/14332583-morocco-a-chaotic-paradise-part-1" target="_self">Morocco - A Chaotic Paradise (Part 1)</a></h3>
								<hr />
								<div class="article-loop-excerpt rte">
									<p><a href="http://cloudeight-nero.myshopify.com/blogs/news/14332583-morocco-a-chaotic-paradise-part-1" title="Morocco - A Chaotic Paradise (Part 1)"><img src="http://cdn.shopify.com/s/files/1/0522/9261/files/tumblr_n5e0flmR0u1st5lhmo1_1280.jpg?7" class="block" /></a></p>
								</div>
								<hr />
								<p class="article-loop-details bm-remove text-right">
									By <a href="javascript:void();" target="_self" class="tip-t-fade" data-tooltip="<img src='http://www.gravatar.com/avatar/64e8d42afadce7dfcac8031d25707a6b?s=500' alt='Gravatar Image' class='block' style='width: 100px; height: 100px;' />">Joe Mottershaw</a> on <time pubdate datetime="2014-06-03">Jun 03, 2014</time>
									<strong>&nbsp;&bull;&nbsp;</strong> <a href="/blogs/news/14332583-morocco-a-chaotic-paradise-part-1#article-comments" target="_self"><i class="fa fa-comments fa-fw"></i> 0 Comments</a>
								</p>
							</div>
						</article>
						<div class="clear"></div>

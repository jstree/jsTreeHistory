	...
	<body id="dongmin-lee" class="template-index" itemscope itemtype="http://schema.org/WebPage">
		...
		<div class="page-border clearfix">
				...
				<div class="container bm-larger">
					<div id="navigation" class="clearfix">
						...
						<div id="click-nav" class="clearfix">
							...
							<a href="./aboutus.html" target="_self" class="nav-item last" data-sub-nav="about-us-nav-links"> About Us </a>
							...
							<div class="slide-menu">
								...
								<ul class="nav unstyled bm-remove clearfix">
									...
									<li class="nav-item has-dropdown">
										<a href="/collections/all" target="_self" class="parent-link"> Catalog 
										<span class="has-dropdown-icon float-right">+</span>
										</a>
										<ul class="sub-nav unstyled bm-remove">
											<li class="sub-nav-item first active">
												<a href="/collections/all" target="_self" class="first active">&raquo; &nbsp;All Products</a>
											</li>
											<li class="sub-nav-item">
												<a href="/collections/jackets" target="_self" class="">&raquo; &nbsp;Jackets</a>
											</li>
											<li class="sub-nav-item">
												<a href="/collections/dresses" target="_self" class="">&raquo; &nbsp;Dresses</a>
											</li>
											<li class="sub-nav-item">
												<a href="/collections/jumpers" target="_self" class="">&raquo; &nbsp;Jumpers</a>
											</li>
											<li class="sub-nav-item">
												<a href="/collections/tops" target="_self" class="">&raquo; &nbsp;Tops</a>
											</li>
											<li class="sub-nav-item">
												<a href="/collections/shirts" target="_self" class="">&raquo; &nbsp;Shirts</a>
											</li>
											<li class="sub-nav-item">
												<a href="/collections/t-shirts" target="_self" class="">&raquo; &nbsp;T-Shirts</a>
											</li>
											<li class="sub-nav-item">
												<a href="/collections/jeans" target="_self" class="">&raquo; &nbsp;Jeans</a>
											</li>
											<li class="sub-nav-item">
												<a href="/collections/shorts" target="_self" class="">&raquo; &nbsp;Shorts</a>
											</li>
											<li class="sub-nav-item last">
												<a href="/collections/swim-suits" target="_self" class="last">&raquo; &nbsp;Swim Suits</a>
											</li>
										</ul>
									</li>
									<li class="nav-item has-dropdown">
										<a href="/collections/all" target="_self" class="parent-link"> TestSubMenu2 
										<span class="has-dropdown-icon float-right">+</span>
										</a>
										<ul class="sub-nav unstyled bm-remove">
											<li class="sub-nav-item first active">
									...
									<li class="nav-item "><a href="./blog.html" target="_self" class=""> Blog </a>
									</li>
									<li class="nav-item  last"><a href="./aboutus.html" target="_self" class=" last"> About Us </a>
									</li>
									<hr class="bm-smaller" />
								</ul>
							</div>
					...
					<div id="secondary-navigation" class="clearfix">
						<div id="catalog-nav-links" class="sub-nav">
							<a href="./catalog_products.html" target="_self" class="sub-nav-item first active">All Products</a>
							<a href="#" target="_self" class="sub-nav-item">Jackets</a>
							<a href="#" target="_self" class="sub-nav-item last">Swim Suits</a>
						</div>
						<div id="account-nav-links" class="sub-nav">
							<a href="./login.html" target="_self" class="sub-nav-item">Log In</a>
							<a href="./register.html" target="_self" class="sub-nav-item last">Register</a>
						</div>
					</div>
				</div>
			</nav>
			...
			<main id="template-article-liquid" class="clearfix" role="main" itemscope itemtype="http://schema.org/Article">
					...
					<div class="container bm-medium">
						<div class="one-whole">
							...
							<div class="text-center">
								<h1 class="bm-remove">
									Morocco - A Chaotic Paradise (Part 2)
								</h1>
								<p class="bm-remove">
									<a href="/" target="_self">Home</a>
									&nbsp;/&nbsp;
									<a href="/blogs/news" target="_self">Blog - News</a> <small>[ <a href="/blogs/News.atom" target="_blank">RSS</a> ]</small>
									&nbsp;/&nbsp;
									Morocco - A Chaotic Paradise (Part 2)
								</p>
							</div>
					...
					<div class="clearfix">
						<div class="container bm-remove">
							<div id="article" class="one-whole boxed p-twenty animate-in clearfix" data-anim-type="fade-in" data-anim-delay="0">
								<h1 id="article-title" class="no-display"><a href="/blogs/news/14332611-morocco-a-chaotic-paradise-part-2" target="_self"><span itemprop="name">Morocco - A Chaotic Paradise (Part 2)</span></a></h1>
								<div class="article-body rte" itemprop="articleBody">
									<p><img src="http://cdn.shopify.com/s/files/1/0522/9261/files/tumblr_n5waxesawa1st5lhmo1_1280.jpg?7" class="block" /></p>
									<p>We stirred from our restless slumber as the coach jolted its way through the narrow streets leading to Marrakech, Grace brushed her waves of auburn hair out of her face and I checked my watch: It was four in the afternoon. We grabbed our board bags and flagged down the latest in a long run of drive by taxis and headed for our new abode.</p>
									<p>Once in Marrakech, our driver signaled us to follow a lingering youngster to our Riad (a Moroccan guest house). Considering we'd just arrived and had no map or sense of direction, we had very little choice in the matter. We followed him through shadowed alleyways, abruptly stopping before each one and telepathically expressing our unwillingness to get mugged. Hesitantly, we strolled on and soon arrived outside a door at the bottom of a passageway with the name of our Riad tiled above it, Riad Selouane. Relieved, we dropped our luggage and rang the bell.</p>
								</div>
								<hr class="bm-remove tm-medium" />
								<div class="one-half-percent tablet-mobile bm-remove tm-medium">
									<div id="article-author">
										By <a href="javascript:void();" target="_self" class="tip-t-fade" data-tooltip="<img src='http://www.gravatar.com/avatar/64e8d42afadce7dfcac8031d25707a6b?s=500' alt='Gravatar Image' class='block' style='width: 100px; height: 100px;' />">Joe Mottershaw</a> on <time pubdate datetime="2014-06-03" itemprop="datePublished">Jun 03, 2014</time>
									</div>
									<div id="article-tags">
										<small>
										<i class="fa fa-tags fa-fw"></i> Tagged:
										<a href="/blogs/news/tagged/morocco" target="_self">morocco</a>
										</small>
									</div>
								</div>
								<div id="article-social-sharing" class="one-half-percent tablet-mobile bm-remove tm-medium last">
									<span class="sharing-icon facebook tip-t-fade" data-tooltip="Share this on Facebook"><a href="http://www.facebook.com/sharer/sharer.php?u=http://cloudeight-nero.myshopify.com/blogs/news/14332611-morocco-a-chaotic-paradise-part-2" target="_blank"><i class="fa fa-facebook"></i></a></span>
									<span class="sharing-icon twitter tip-t-fade" data-tooltip="Share this on Twitter"><a href="https://twitter.com/intent/tweet?text=Nero:%20Morocco - A Chaotic Paradise (Part 2)%20-%20http://cloudeight-nero.myshopify.com/blogs/news/14332611-morocco-a-chaotic-paradise-part-2" target="_blank"><i class="fa fa-twitter"></i></a></span>
									<span class="sharing-icon google-plus tip-t-fade" data-tooltip="Share this on Google+"><a href="https://plus.google.com/share?url=http://cloudeight-nero.myshopify.com/blogs/news/14332611-morocco-a-chaotic-paradise-part-2" target="_blank"><i class="fa fa-google-plus"></i></a></span>
									<span class="sharing-icon pinterest tip-t-fade" data-tooltip="Share this on Pinterest"><a href="//pinterest.com/pin/create/button/?url=http://cloudeight-nero.myshopify.com/blogs/news/14332611-morocco-a-chaotic-paradise-part-2&amp;media=http://cdn.shopify.com/s/files/1/0522/9261/files/tumblr_n5waxesawa1st5lhmo1_1280.jpg?7&amp;description=" target="_blank"><i class="fa fa-pinterest"></i></a></span>
									<span class="sharing-icon mail tip-t-fade" data-tooltip="Email this to a friend"><a href="mailto:?subject=Morocco - A Chaotic Paradise (Part 2)&amp;body=Hey,%20while%20browsing%20Nero%20I%20found%20a%20great%20article%20that%20I%20thought%20you%20might%20like%20to%20read.%0D%0A%0D%0AMorocco - A Chaotic Paradise (Part 2)%0D%0Ahttp://cloudeight-nero.myshopify.com/blogs/news/14332611-morocco-a-chaotic-paradise-part-2" target="_blank"><i class="fa fa-envelope"></i></a></span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container">
					<div id="article-navigation" class="one-whole animate-in clearfix" data-anim-type="fade-in" data-anim-delay="0">
						<a href="/blogs/news/14332583-morocco-a-chaotic-paradise-part-1" target="_self" id="article-prev" class="button float-left">Previous</a>
					</div>
				</div>
				<div class="clearfix">
					<div class="container bm-medium">
						<div class="one-whole boxed p-twenty animate-in clearfix" data-anim-type="fade-in" data-anim-delay="0">
							<div id="article-comments">
								<h1 id="article-comments-title">2 Comments</h1>
								<hr />
								<div class="clearfix">
									<div class="article-comment odd loop-first clearfix">
										<div class="article-comment-user-image">
											<img src="http://www.gravatar.com/avatar/7a3da42f03118df0d3190e5a95d87677?s=500" alt="Joe Mottershaw's Gravatar Image" class="block" />
										</div>
										<div class="article-comment-user-comment rte">
											<p class="bm-small"><strong>Joe Mottershaw</strong><span class="article-comment-date-bull"> <small>&nbsp;&bull;&nbsp;</small> </span><br class="article-comment-user-date-br" />Jun 19, 2014</p>
								...
								<div class="clearfix">
									<div class="article-comment even loop-last clearfix">
										<div class="article-comment-user-image">
											<img src="http://www.gravatar.com/avatar/7a3da42f03118df0d3190e5a95d87677?s=500" alt="Joe Mottershaw's Gravatar Image" class="block" />
										</div>
										<div class="article-comment-user-comment rte">
							...
							<div id="article-post-comment">
								...
								<form accept-charset="UTF-8" action="/blogs/news/14332611-morocco-a-chaotic-paradise-part-2/comments" class="comment-form" id="article-14332611-comment-form" method="post">
									<input name="form_type" type="hidden" value="new_comment" /><input name="utf8" type="hidden" value="✓" />
									<script>
									...
									<div class="one-half-percent bm-remove omega">
										<input type="text" name="comment[author]" id="article-comment-author" class="w-full" placeholder="Name" value="" />
									</div>
									<div class="one-half-percent bm-remove alpha last">
										<input type="email" name="comment[email]" id="article-comment-email" class="w-full" placeholder="Email Address" value="" />
									</div>
									<textarea name="comment[body]" id="article-comment-body" class="w-full" placeholder="Your Comment..."></textarea>
									<div class="clearfix">

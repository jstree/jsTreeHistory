					...
					<div class="container bm-remove">
						<div id="article" class="one-whole boxed p-twenty animate-in clearfix" data-anim-type="fade-in" data-anim-delay="0">
							<div class="article-body rte" itemprop="articleBody">
								...
								<p>인터넷을 통한 온라인 매매 시장이 오프라인의 그것을 대체하는 비중이 높아지게 되면서 게시판 기능을 바탕으로 한 온라인 상거래 쇼핑몰 구축의 필요성이 제시되었고, 이러한 쇼핑몰을 쉽고 빠르게 구축할 수 있는 솔루션에 대한 요구가 지속되어 왔습니다.<br />
								기존에는 제로보드, 그누보드 등 PHP를 기반으로 한 게시판 솔루션이 이러한 기능을 제공하였으나, 보안 및 확장성 등에 대한 문제점을 가지고 있어 이를 보완할 수 있는 차세대 솔루션의 필요성이 대두되고 있습니다. <br />
								이에  우리는 전자정부 표준프레임워크를 기본 바탕으로 하는 Java 기반의 게시판 솔루션인 바로보드를 개발하여 기존 솔루션의 단점을 보완하고 뛰어난 확장성을 가지는 차세대 버전의 게시판 솔루션을 제공하고자 합니다.

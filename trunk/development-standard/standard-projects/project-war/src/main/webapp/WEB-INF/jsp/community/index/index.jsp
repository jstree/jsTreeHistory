						...
						<div id="link-list">
							...
							<div class="content">
								<ul class="unstyled bm-remove">
									<li><strong><span>대한민국 IT에 새로운 생각을 전파하는 것입니다.</span></strong></li>
				...
				<div class="one-whole">
					...
					<div class="one-quarter product-item boxed p-ten text-center odd loop-first animate-in clearfix" data-anim-type="fade-in" data-anim-delay="0">
						<div class="image-and-overlay-container bm-small">
							<div class="image">
								...
								<img src="http://dummyimage.com/500/ffffff/f45a4f.png&text= We&nbsp;" alt="" class="block" />
								</a>
							</div>
					...
					<div class="one-quarter product-item boxed p-ten text-center odd loop-first  animate-in clearfix" data-anim-type="fade-in" data-anim-delay="0">
						...
						<p class="bm-remove">
							...
							'어떻게 하면 다양하게 확장이 가능한, 개발기간이 짧고 쉬운 모듈을 만들 수 있을까?' JsTree는 이 문제를 해결 할 우리의 솔루션입니다.
						</p>
					</div>

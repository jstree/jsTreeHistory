...
<script type="text/javascript">
	function fnGetList(pageNum){
		callAjax('noteForm'
                , '${pageContext.request.contextPath}/user/note/inquiryNoteList.do?currentPageNo=' + pageNum
                , null
                , 'get'
                , 'json'
                , null
	...
	$(function () {	
		...
		$('#noteSendBtn').bind('click', function(e){
			window.open('${pageContext.request.contextPath}/user/note/noteSendPopup.do'
					, '쪽지 보내기'
	...
	function fnDeleteNote(deleteList){
		callAjax(  null
                  , '${pageContext.request.contextPath}/user/note/deleteNoteList.do'
                  , null
                  , 'post'
                  , 'json'
                  , {
	...
	function fnNoteDetailPop(notdDispId){
		window.open('${pageContext.request.contextPath}/user/note/noteDetailPopup.do?notdDispId=' + notdDispId
				, '상세보기'
				, 'width=600, height=550, resizable=no, scrollbars=no, status=no, menubar=no');
	}
</script>
...
<section>
	<div class="three-quarter last boxed p-twenty clearfix" data-anim-type="fade-in" data-anim-delay="0">
		...
		<div id="search" class="one-whole boxed p-twenty search-area">
			<form id="noteForm" action="${pageContext.request.contextPath}/user/note/inquiryNoteList.do" method="get">

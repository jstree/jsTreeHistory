...
<div id="nav">	
	...
	<ul>
		...
		<li class="leftmenu_dept01">
			<a href="javascript:fn_main_headPageMove('21','/jsp/main/sample_menu/EgovProductInfo')">정보마당</a>
			<ul>	
		...
		<li class="leftmenu_dept01">
			<a href="javascript:fn_main_headPageMove('31','/jsp/main/sample_menu/EgovDownload')">고객지원</a>
			<ul>
		...
		<li class="leftmenu_dept01">
			<a href="javascript:fn_main_headPageAction('41','cop/smt/sim/EgovIndvdlSchdulManageWeekList.do')">알림마당</a>
			<ul>
		...
		<li class="leftmenu_dept01">
			...
			<ul>	
                ...
                <li class="dept02"><a href="javascript:fn_main_headPageAction('58','cop/com/newsletterMgr.do')">뉴스레터관리</a></li>
			</ul> 
		</li>
		<% } %>
	</ul>

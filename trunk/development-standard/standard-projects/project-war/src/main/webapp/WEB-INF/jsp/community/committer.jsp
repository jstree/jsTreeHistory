...
<!--<![endif]-->
	<head data-placeholder-focus="false" data-placeholder-live="false">
		...
		<meta name="description" content="313 Developer Group" />
		...
		<meta property="og:site_name" content="313 Developer Group">
	...
	<body id="313 Developer Group" class="template-index" itemscope itemtype="http://schema.org/WebPage">
			...
			<header class="clearfix">
				<div id="header" class="container">
					...
					<div id="header-logo" class="one-third bm-remove">
						<a href="/" target="_self"> 313 Developer Group </a>
					</div>
				...
				<div class="container">
					<div class="one-whole">
						...
						<div class="one-whole bm-larger boxed p-twenty animate-in" data-anim-type="fade-in" data-anim-delay="0">
							<p class="bm-larger tm-larger text-center">313 개발그룹 킹왕짱</p>
						</div>
						<!-- 요기부터 작업 ! -->
						<div class="one-quarter product-item boxed p-ten text-center odd loop-first animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							<div class="image-and-overlay-container bm-small">
								<div class="image profile-box">
									<a href="#" target="_self">
										<img src="./images/test_img.jpg" alt="이동민" class="block" />
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>이동민</strong></a>
								<br />
								AhnLab
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center even loop-first animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							<div class="image-and-overlay-container bm-small">
								<div class="image profile-box">
									<a href="./baroBoardOverView.html" target="_self">
										<img src="./images/test_img.jpg" alt="최민석" class="block" />
										<span class="profile-box-title">
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>최민석</strong></a>
								<br />
								쓰리웨어
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center odd loop-first animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							<div class="image-and-overlay-container bm-small">
								<div class="image profile-box">
									<a href="./baroBoardOverView.html" target="_self">
										<img src="./images/test_img.jpg" alt="김병우" class="block" />
										<span class="profile-box-title">
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>김병</strong></a>
								<br />
								삼성SDS
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center even last loop-first    animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							<div class="image-and-overlay-container bm-small">
								<div class="image profile-box">
									<a href="./baroBoardOverView.html" target="_self">
										<img src="./images/test_img.jpg" alt="김대근" class="block" />
										<span class="profile-box-title">
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>김대근</strong></a>
								<br />
								유진시스템즈
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center odd loop-first animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							<div class="image-and-overlay-container bm-small">
								<div class="image profile-box">
									<a href="#" target="_self">
										<img src="./images/test_img.jpg" alt="류강하" class="block" />
										<span class="profile-box-title">
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>류강</strong></a>
								<br />
								아이지오
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center even loop-first animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							<div class="image-and-overlay-container bm-small">
								<div class="image profile-box">
									<a href="./baroBoardOverView.html" target="_self">
										<img src="./images/test_img.jpg" alt="유창근" class="block" />
										<span class="profile-box-title">
											<span class="profile-box-name">Changgeun Yu</span>
											<span class="profile-box-role">Developer</span>
										</span>
									</a>
								</div>
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>유창근</strong></a>
								<br />
								위메프
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center odd loop-first animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>손호성</strong></a>
								<br />
								-
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center even last loop-first    animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							<div class="image-and-overlay-container bm-small">
								<div class="image profile-box">
									<a href="./baroBoardOverView.html" target="_self">
										<img src="./images/test_img.jpg" alt="유정우" class="block" />
										<span class="profile-box-title">
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>유정우</strong></a>
								<br />
								이젠
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center odd loop-first animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							<div class="image-and-overlay-container bm-small">
								<div class="image profile-box">
									<a href="#" target="_self">
										<img src="./images/test_img.jpg" alt="정원기" class="block" />
										<span class="profile-box-title">
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>정원기</strong></a>
								<br />
								하나INS
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center even loop-first animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>전경훈</strong></a>
								<br />
								tsis
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center odd loop-first animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							<div class="image-and-overlay-container bm-small">
								<div class="image profile-box">
									<a href="./baroBoardOverView.html" target="_self">
										<img src="./images/test_img.jpg" alt="이종렬" class="block" />
										<span class="profile-box-title">
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>이종렬</strong></a>
								<br />
								대교CNS
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center even last loop-first    animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							<div class="image-and-overlay-container bm-small">
								<div class="image profile-box">
									<a href="./baroBoardOverView.html" target="_self">
										<img src="./images/test_img.jpg" alt="오권우" class="block" />
										<span class="profile-box-title">
											<span class="profile-box-name">Kwonwoo Oh</span>
											<span class="profile-box-role">Developer</span>
										</span>
									</a>
								</div>
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>오권우</strong></a>
								<br />
								-
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center odd loop-first animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>최대열</strong></a>
								<br />
								위메프
							</p>
							<div>
						...
						<div class="one-quarter product-item boxed p-ten text-center even loop-first animate-in clearfix profile-frame" data-anim-type="fade-in" data-anim-delay="0">
							<div class="image-and-overlay-container bm-small">
								<div class="image profile-box">
									<a href="./baroBoardOverView.html" target="_self">
										<img src="./images/test_img.jpg" alt="이태경" class="block" />
										<span class="profile-box-title">
							...
							<p class="bm-remove no-text-overflow">
								<a href="./baroBoardOverView.html" target="_self"><strong>이태</strong></a>
								<br />
								Solideos
							</p>
							<div>

							...
							<div class="article-body rte" itemprop="articleBody">
								...
								<div class="tablet-mobile alpha bm-remove last">
									<div class="one-half-percent tablet-mobile bm-remove omega alignleft">
										<img src="/assets/images/community/jsTreeAlg/jsTreeConcept/iStock_000017765581Small.jpg" alt="" />
									</div>
									...
									<p>고객의 Needs가 변화하더라도 설계를 유연하게 할 수 있는 방법은 없을까?를 고민한 끝에 JsTree 만이 이 문제를 해결할 수 있을것이라고 생각했습니다. 단일한 알고리즘과 데이터 모델의 메타 데이터를 고객의 Needs에 맞춰 변경및 변형을 통하여, 설계를 유연하게 변경하며, 단일 집합 내에서의 변경이 외부의 영향을 받는 서비스 코드만을 변경하면 되는 방법을 구현하였습니다.</p>

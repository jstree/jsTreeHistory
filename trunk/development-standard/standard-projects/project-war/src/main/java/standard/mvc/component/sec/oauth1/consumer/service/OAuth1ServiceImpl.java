package standard.mvc.component.sec.oauth1.consumer.service;
...
public class OAuth1ServiceImpl implements OAuth1Service {
  ...
  public String getTwiterRestTemplate(){
	//JsonObject root =(JsonObject) new JsonParser().parse(responseString);
	  return getTwitterRestTemplate().getForObject(URI.create("https://api.twitter.com/1.1/account/verify_credentials.json"), String.class);
  }
...
public OAuthRestTemplate getTwitterRestTemplate() {
	return twitterRestTemplate;
}

public void setTwitterRestTemplate(OAuthRestTemplate twitterRestTemplate) {

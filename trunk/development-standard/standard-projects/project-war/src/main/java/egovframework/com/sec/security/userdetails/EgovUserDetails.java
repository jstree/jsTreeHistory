...
public class EgovUserDetails extends User {
	...
	public EgovUserDetails(String username, String password, boolean enabled,
			...
			boolean accountNonLocked, Collection<? extends GrantedAuthority> authorities, Object egovVO)
			throws IllegalArgumentException {
	...
	public EgovUserDetails(String username, String password, boolean enabled, Object egovVO)
	    throws IllegalArgumentException {
		this(username, password, enabled, true, true, true, Arrays.asList(new GrantedAuthority[] {new SimpleGrantedAuthority("HOLDER")}), egovVO);
	}

...
COMMENT ON COLUMN T_USER_PASSWORD_SECURITY_LEVEL.C_TITLE IS '비밀번호보안수준';

COMMENT ON COLUMN T_USER_PASSWORD_SECURITY_LEVEL.C_TYPE IS '노드타입';

--CREATE UNIQUE INDEX PK_T_USER_PASSWORD_SECURITY_LEVEL
...
ALTER TABLE T_USER_PASSWORD_SECURITY_LEVEL
    ADD
        CONSTRAINT PK_T_USER_PWD_SECURITY_LEVEL
        PRIMARY KEY (
            C_ID
        );
...
ALTER TABLE T_USER_BASIC_SETTING
    ADD
        CONSTRAINT FK_T_USER_PWD_SECURITY_LEVEL
        FOREIGN KEY (

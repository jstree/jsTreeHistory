...
INSERT INTO T_USER_JOIN_FIELD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_USE_FL, C_INFO_OPEN_FL, C_ESSE_INPUT_FL)
VALUES (2, 1, 0, 2, 21, 1, '회원_가입필드', 'drive', ' ', ' ', ' ');

INSERT INTO T_USER_JOIN_FIELD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_USE_FL, C_INFO_OPEN_FL, C_ESSE_INPUT_FL)
VALUES (3, 2, 0, 3, 4, 2, '이메일 주소', 'default', '1', '1', '1');

INSERT INTO T_USER_JOIN_FIELD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_USE_FL, C_INFO_OPEN_FL, C_ESSE_INPUT_FL)
VALUES (4, 2, 1, 5, 6, 2, '비밀번호', 'default', '1', '0', '1');

INSERT INTO T_USER_JOIN_FIELD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_USE_FL, C_INFO_OPEN_FL, C_ESSE_INPUT_FL)
VALUES (5, 2, 2, 7, 8, 2, '닉네임', 'default', '1', '1', '1');

INSERT INTO T_USER_JOIN_FIELD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_USE_FL, C_INFO_OPEN_FL, C_ESSE_INPUT_FL)
VALUES (6, 2, 3, 9, 10, 2, '비밀번호 찾기 질문/답변', 'default', '1', '0', '1');

INSERT INTO T_USER_JOIN_FIELD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_USE_FL, C_INFO_OPEN_FL, C_ESSE_INPUT_FL)
VALUES (7, 2, 4, 11, 12, 2, '홈페이지', 'default', '1', '1', '1');

INSERT INTO T_USER_JOIN_FIELD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_USE_FL, C_INFO_OPEN_FL, C_ESSE_INPUT_FL)
VALUES (8, 2, 5, 13, 14, 2, '블로그', 'default', '1', '1', '1');

INSERT INTO T_USER_JOIN_FIELD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_USE_FL, C_INFO_OPEN_FL, C_ESSE_INPUT_FL)
VALUES (9, 2, 6, 15, 16, 2, '서명', 'default', '1', '1', '1');

INSERT INTO T_USER_JOIN_FIELD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_USE_FL, C_INFO_OPEN_FL, C_ESSE_INPUT_FL)
VALUES (10, 2, 7, 17, 18, 2, '프로필사진', 'default', '1', '1', '1');

INSERT INTO T_USER_JOIN_FIELD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_USE_FL, C_INFO_OPEN_FL, C_ESSE_INPUT_FL)
VALUES (11, 2, 8, 19, 20, 2, '사용자아이콘', 'default', '1', '1', '1');

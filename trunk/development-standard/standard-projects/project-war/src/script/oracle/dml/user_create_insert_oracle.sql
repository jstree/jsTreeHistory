...
INSERT INTO T_USER_PROH_WORD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_TYPE_CD)
VALUES (3, 2, 0, 3, 4, 2, '이메일', 'folder', 'A');

INSERT INTO T_USER_PROH_WORD (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_TYPE_CD)
VALUES (4, 2, 1, 5, 6, 2, '닉네임', 'folder', 'B');
...
INSERT INTO T_USER_TERMS_OF_USE (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_COMPANY_INTR, C_TERMS_OF_USE, C_PRIVACY_POLICY)
VALUES (1, 0, 0, 1, 4, 0, 'Root Node', 'root', ' ', ' ', ' ');

INSERT INTO T_USER_TERMS_OF_USE (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_COMPANY_INTR, C_TERMS_OF_USE, C_PRIVACY_POLICY)
VALUES (2, 1, 0, 2, 3, 1, '회원_이용약관', 'drive', ' ', ' ', ' ');
...
INSERT INTO T_USER_BASIC_SETTING (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_PASSWORD_SECURITY_LEVEL_CD, C_WEB_MASTER_NM, C_WEB_MASTER_EMAIL, C_JOIN_APPROVAL_FL, C_EMAIL_AUTH_USE_FL, C_PASSWORD_CHANGE_DCNT, C_LOGIN_LIMIT_DCNT, C_LOGIN_FAILURE_LIMIT_CNT)
VALUES (1, 0, 0, 1, 4, 0, 'Root Node', 'root', 1, ' ', ' ', ' ', ' ', -1, -1, -1);

INSERT INTO T_USER_BASIC_SETTING (C_ID, C_PARENTID, C_POSITION, C_LEFT, C_RIGHT, C_LEVEL, C_TITLE, C_TYPE, C_PASSWORD_SECURITY_LEVEL_CD, C_WEB_MASTER_NM, C_WEB_MASTER_EMAIL, C_JOIN_APPROVAL_FL, C_EMAIL_AUTH_USE_FL, C_PASSWORD_CHANGE_DCNT, C_LOGIN_LIMIT_DCNT, C_LOGIN_FAILURE_LIMIT_CNT)
VALUES (2, 1, 0, 2, 3, 1, '회원_기본설정', 'drive', 1, ' ', ' ', ' ', ' ', -1, -1, -1);

...
public class DB_MoveNode extends EgovComAbstractDAO implements I_DB_MoveNode
{
            ...
            List<T_ComprehensiveTree> childNodesFromNodeByRef)
    {
        ...
        try
        {
            ...
            {
                c_idsByChildNodeFromNodeById = CollectionUtils
                        .collect(childNodesFromNodeById,
                ...
                if (c_idsByChildNodeFromNodeById.contains(p_ComprehensiveTree
                        .getRef())) { throw new RuntimeException(
            ...
            this.stretchPositionForMyselfFromJstree(c_idsByChildNodeFromNodeById,
                                                    nodeById,
                                                    p_ComprehensiveTree);
            ...
            if (nodeById != null)
            {
                ...
                if (p_ComprehensiveTree.getCopyBooleanValue())
                {
                    ...
                    int ind = this
                            .pasteMyselfFromJstree(p_ComprehensiveTree.getRef(),
                                                   comparePosition,
                                                   spaceOfTargetNode,
                                                   targetNodeLevel,
                                                   c_idsByChildNodeFromNodeById,
            ...
            throws SQLException
    {
        ...
        getSqlMapClientTemplate().getSqlMapClient()
                .update("jstreeStrutsiBatis.cutMyselfPositionFix",
                        p_OnlyCutMyselfFromJstree);
        getSqlMapClientTemplate().getSqlMapClient()
                .update("jstreeStrutsiBatis.cutMyselfLeftFix",
                        p_OnlyCutMyselfFromJstree);
        getSqlMapClientTemplate().getSqlMapClient()
                .update("jstreeStrutsiBatis.cutMyselfRightFix",
                        p_OnlyCutMyselfFromJstree);
    }
            ...
            P_ComprehensiveTree p_ComprehensiveTree) throws SQLException
    {
        ...
        getSqlMapClientTemplate().getSqlMapClient()
                .update("jstreeStrutsiBatis.stretchPositionForMyself",
                        p_ComprehensiveTree);
            ...
            throws SQLException
    {
        ...
        getSqlMapClientTemplate().getSqlMapClient()
                .update("jstreeStrutsiBatis.stretchLeftForMyselfFromJstree",
                        p_OnlyStretchLeftRightForMyselfFromJstree);
        getSqlMapClientTemplate().getSqlMapClient()
                .update("jstreeStrutsiBatis.stretchRightForMyselfFromJstree",
                        p_OnlyStretchLeftRightForMyselfFromJstree);
    }
            ...
            throws SQLException
    {
        ...
        return (Integer) getSqlMapClientTemplate().getSqlMapClient()
                .insert("jstreeStrutsiBatis.pasteMyselfFromJstree",
                        p_OnlyPasteMyselfFromJstree);
    }
            ...
            throws SQLException
    {
        ...
        getSqlMapClientTemplate().getSqlMapClient()
                .update("jstreeStrutsiBatis.enterMyselfFixPosition",
                        p_OnlyPasteMyselfFromJstree);
        getSqlMapClientTemplate().getSqlMapClient()
    ...
    public void fixCopy(int ind, int ref) throws SQLException
    {
        ...
        for (int i = 0; i < children.size(); i++)
        {
            ...
            if (child.getC_id() == ind)
            {
                ...
                getSqlMapClientTemplate().getSqlMapClient()
                        .update("jstreeStrutsiBatis.fixCopyIF",

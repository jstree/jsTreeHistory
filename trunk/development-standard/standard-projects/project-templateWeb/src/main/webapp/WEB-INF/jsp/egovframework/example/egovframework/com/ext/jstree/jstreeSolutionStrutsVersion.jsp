...
$("#demo")
	...
	.jstree({ 
		...
		"json_data" : { 
			...
			"ajax" : {
				...
				"url" : "/egovframework/com/etc/jstree/core/getChildNode.do",
		...
		"search" : {
			...
			"ajax" : {
				"url" : "/egovframework/com/etc/jstree/core/searchNode.do",
	...
	.bind("create.jstree", function (e, data) {
		$.post(
			"/egovframework/com/etc/jstree/core/addNode.do", 
			{ 
	...
	.bind("remove.jstree", function (e, data) {
		data.rslt.obj.each(function () {
			$.ajax({
				async : false,
				type: 'POST',
				url: "/egovframework/com/etc/jstree/core/removeNode.do",
				data : { 
	...
	.bind("rename.jstree", function (e, data) {
		$.post(
				"/egovframework/com/etc/jstree/core/alterNode.do", 
			{ 
	...
	.bind("set_type.jstree", function (e, data) {
		$.post(
				"/egovframework/com/etc/jstree/core/alterNodeType.do", 
			{ 
					"c_id" : data.rslt.obj.attr("id").replace("node_","").replace("copy_",""),
					"c_title" : data.rslt.new_name,
					"c_type" : data.rslt.obj.attr("rel")
	...
	.bind("move_node.jstree", function (e, data) {
		data.rslt.o.each(function (i) {
			$.ajax({
				async : false,
				type: 'POST',
				url: "/egovframework/com/etc/jstree/core/moveNode.do",
				data : { 

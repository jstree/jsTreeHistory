package egovframework.cop.ems.controller;
 ...
 */
@Controller
@RequestMapping(value = { "/egovframework/com/cop/ems" })
public class SndngMailController {
	
	@Autowired
	UserInfoService userInfoService;
	
	@RequestMapping(value = "/santMailConfirm.do", method = RequestMethod.POST)

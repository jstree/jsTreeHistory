				...
				<div class="clearfix">
								...
								<div id="description">
									<div id="mmenu" style="clear: both;" class="clearfix">
										<div class="desktop-tablet alpha boxed bm-remove btn_wrap01">
											...
											<button type="button" id="analyze" title="analyze" onclick="$('#alog').load('${pageContext.request.contextPath}/com/ext/jstree/springHibernate/core/analyzeNode.do');">
                    ...
                    function jstreeDataTableReload() {
                      var jstreeDataTable = $('#jstreeTable').dataTable({
                        "ajax": {
                          "url": "${pageContext.request.contextPath}/com/ext/jstree/springHibernate/monitor/list.do",
                          "dataSrc": "rows"
                        },
                        "processing": true,
                        "responsive": true,
                  ...
                  <customTags:jstree target="#demo" getChildNode="${pageContext.request.contextPath}/com/ext/jstree/springHibernate/core/getChildNode.do"
										...
										moveNode="${pageContext.request.contextPath}/com/ext/jstree/springHibernate/core/moveNode.do"></customTags:jstree>
								</div>
							</div>
						</div>
					</div>

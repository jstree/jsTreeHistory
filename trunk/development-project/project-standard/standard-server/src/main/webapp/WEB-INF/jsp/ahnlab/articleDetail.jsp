	...
	<div class="wrap">
      ...
      function checkMobileDevice() {
		...
		<div class="footerWrap">
			...
			<ul class="ftMenu">
				<li>
					<a href="http://company.ahnlab.com/" target="_blank" title="새창-회사소개 사이트 가기" class="footerTabCss" id="footerfocus">회사소개</a>
				</li>
				<li>
					<a href="http://company.ahnlab.com/company/site/ir/present_stock_price.jsp" target="_blank" title="새창-투자정보 사이트 가기">투자정보</a>
				</li>
				<li>
					<a href="https://ahnlab.recruiter.co.kr/" target="_blank" title="새창-채용정보 사이트 가기">채용정보</a>
				</li>
				<li>
					<a href="http://www.ahnlab.com/kr/site/etc/policy.do">
						<strong>개인정보취급방침</strong>
					</a>
				</li>
				<li>
					<a href="http://www.ahnlab.com/kr/site/etc/agreement.do">이용약관</a>
				</li>
				<li>
					<a href="http://www.ahnlab.com/kr/site/etc/contactUs.do" class="ls0">Contact Us</a>
				</li>
				<li>
					<a href="http://www.ahnlab.com/kr/site/etc/sitemap.do">사이트맵</a>
				</li>
				<li id="mobile" style="display: none;">
					<a href="http://www.ahnlab.com/kr/site/support/notice/noticeView.do#" title="모바일" onclick="mobileGo();">모바일웹</a>
				</li>
			</ul>
			<div class="familyWrap familySiteCombo">
				<p class="family">
					<a href="http://www.ahnlab.com/kr/site/support/notice/noticeView.do#" class="comboLink2 " title="패밀리 사이트 목록 보기">FAMILY
						SITE</a>
				</p>
				<!-- layer -->
				<div class="lyUtill">
			...
			<div class="locSiteWrap globalSiteCombo">
				<p class="locSite">
					<a href="http://www.ahnlab.com/kr/site/support/notice/noticeView.do#" class="comboLink2" title="국가별 사이트 목록 보기">한국</a>
				</p>
				<!-- layer -->
				<div class="lyUtill">
					<div class="lyWrap">
						<p class="selected">
							<a href="http://www.ahnlab.com/kr/site/main.do" target="_blank" rel="nofollow" title="새창. 한국 사이트로 바로가기">한국 (한국어)</a>
						</p>
						<p>
							<a href="http://global.ahnlab.com/site/main.do" target="_blank" rel="nofollow" title="새창. Global 사이트로 바로가기">Global
								(English)</a>
						</p>
						<p>
							<a href="http://apac.ahnlab.com/site/main.do" target="_blank" rel="nofollow" title="새창. APAC 사이트로 바로가기">APAC (English)</a>
						</p>
						<p>
							<a href="http://jp.ahnlab.com/site/main.do" target="_blank" rel="nofollow" class="fJapan" title="새창. 日本 사이트로 바로가기">日本
								(日本語)</a>
						</p>
						<p>
							<a href="http://cn.ahnlab.com/site/main.do" target="_blank" rel="nofollow" class="fChina" title="새창. 中国 사이트로 바로가기">中国
								(简体中文)</a>
						</p>
					</div>
				</div>
			...
			<div class="footInfo">
				<p>
					(우)
					<span class="ls0">13493</span>
					경기도 성남시 분당구 판교역로
					<span class="ls0 pr7">220</span>
					대표이사 :
					<span class="pr7">권치중</span>
					사업자등록번호 :
					<span class="ls0 pr7">214-81-83536</span>
					통신판매신고번호 :
					<span class="ls0">2012-</span>
					경기성남
					<span class="ls0">-1189</span>
				</p>
				<p>
					대표전화 :
					<span class="ls0 pr7">031-722-8000</span>
					<span class="ls0">Fax</span>
					:
					<span class="ls0 pr7">031-722-8901</span>
					구매문의 :
					<span class="ls0 pr7">1588-3096</span>
					개인고객 기술지원 :
					<span class="ls0 pr7">1577-9880</span>
					기업고객 기술지원 :
					<span class="ls0">1577-9431</span>
				</p>
			</div>
		</div>
		</footer>

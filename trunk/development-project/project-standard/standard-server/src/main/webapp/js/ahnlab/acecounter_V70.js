...
if(!_IDV(_GUL)) var _GUL ='acounter.ahnlab.com'; 
...
if( !_od ){ _od = 0 ; }else{ _od = parseInt((_od-19)/17); }
if( _od < 0 || _od > 150 ){ _od = 0; }
...
_AIU.src = _arg+"&url="+escape(a)+"&ref="+escape(_rf)+"&cpu="+_cu+"&bz="+_bz+"&bv="+_vs+"&os="+_os+"&dim="+_d+"&cd="+_cd+"&je="+_je+"&jv="+_sv+"&tz="+_tz+"&ul="+_ul+"&ad_key="+escape(_ak)+"&skey="+_RPS(escape(_skey),"+","%2B")+"&age="+_od+"&gender="+_gd+"&marry="+_mr+"&join="+_jn+"&member_key="+_mk+"&jid="+_jid+"&udf1="+_ud1+"&udf2="+_ud2+"&udf3="+_ud3+"&amt="+_amt+"&frwd="+_fwd+"&pd="+_RPS(escape(_pd),"+","%2B")+"&ct="+_RPS(escape(_ct),"+","%2B")+"&ll="+_RPS(escape(_ll),"+","%2B")+"&RID="+Math.random()+"&";
setTimeout("",300);
}
...
var Asp_Link_ssn={s:20100707,n:'2',g:_GUL,p:_GPT,pu:document.URL,m:[],run:Asp_Link_ssn?Asp_Link_ssn.n:this.n};

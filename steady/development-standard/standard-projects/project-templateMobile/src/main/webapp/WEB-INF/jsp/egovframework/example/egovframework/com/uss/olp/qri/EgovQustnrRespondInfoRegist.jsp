...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="이 표는 설문조사 대상 정보를 제공하며, 설문관리정보, 설문문항정보, 설문유형, 성문항목정보, 응답자답변내용, 기타답변내용, 응답자명 정보로 구성되어 있습니다 .">
  <tr>
	...
	<img src="${ImgUrl}img/search2.gif" align="middle" style="border:0px" alt="설문관리정보" title="설문관리정보">
	</a>
  ...
  <tr>
	...
	<img src="${ImgUrl}img/search2.gif" align="middle" style="border:0px" alt="설문문항정보" title="설문문항정보">
	</a>
  ...
  <tr>
    ...
    <td width="80%" nowrap>
		...
		<img src="${ImgUrl}img/search2.gif" align="middle" style="border:0px" alt="설문항목정보" title="새창">
		</a>

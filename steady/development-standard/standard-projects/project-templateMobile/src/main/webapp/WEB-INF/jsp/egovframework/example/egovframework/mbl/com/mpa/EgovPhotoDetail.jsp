	    ...
	    <tr> 
	        <th width="20%" height="23" class="required_text" nowrap >사진 파일&nbsp;&nbsp;</th>
	            <td colspan="6">
	                ...
	                <img title='<c:out value="${result.photoSj}"/>' alt='<c:out value="${result.photoSj}"/>' src='<c:url value='/cmm/fms/getImage.do'/>?atchFileId=<c:out value="${result.atchFileId}"/>&fileSn=0' class="mcomd-photo"/>
	            </td>
	    </tr>
	  </c:if>      

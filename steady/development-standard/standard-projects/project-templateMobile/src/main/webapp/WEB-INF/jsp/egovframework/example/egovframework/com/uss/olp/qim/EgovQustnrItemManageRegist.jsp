...
<td width="80%" nowrap>
  <input name="qestnrCn" id="qestnrCn" type="text" size="73" value="" title="설문정보 입력" maxlength="4000" style="width:300px;">
   ...
   <img src="${ImgUrl}img/search2.gif" onClick=""align="middle" style="border:0px" alt="설문정보" title="설문정보">
   </a>
...
<td width="80%" nowrap>
  ...
  <img src="${ImgUrl}img/search2.gif" align="middle" alt="설문문항정보" title="설문문항정보">
  </a>

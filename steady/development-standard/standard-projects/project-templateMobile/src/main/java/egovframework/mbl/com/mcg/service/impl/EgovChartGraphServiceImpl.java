...
public class EgovChartGraphServiceImpl extends AbstractServiceImpl implements
    ...
    public ChartGraph selectChartGraph(ChartGraph chartGraph) throws Exception {
        ChartGraph ret =
            (ChartGraph) chartGraphDAO.selectChartGraph(chartGraph);
        return ret;
    }

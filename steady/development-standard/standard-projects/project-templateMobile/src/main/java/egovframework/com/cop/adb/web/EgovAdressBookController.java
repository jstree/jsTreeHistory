...
public class EgovAdressBookController {
    ...
    public String selectUserList(@ModelAttribute("searchVO") AdressBookUserVO adbkUserVO, Map<String, Object> commandMap, ModelMap model) throws Exception {
        ...
        String dataString = URLDecoder.decode((String)adbkUserVO.getSearchWrd(), "UTF-8");
        adbkUserVO.setSearchWrd(dataString);
        
        dataString = URLDecoder.decode((String)adbkUserVO.getSearchCnd(), "UTF-8");
        adbkUserVO.setSearchCnd(dataString);

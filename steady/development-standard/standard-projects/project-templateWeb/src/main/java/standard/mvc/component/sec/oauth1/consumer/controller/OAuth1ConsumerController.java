package standard.mvc.component.sec.oauth1.consumer.controller;
...
import standard.mvc.component.sec.oauth1.consumer.service.OAuth1Service;
import standard.mvc.component.sec.oauth1.consumer.service.SparklrService;
...
@Controller
public class OAuth1ConsumerController extends GenericAbstractController{
	...
	public String google(Model model) {
		...
		return "/jsp/standard/security/oauth1/consumer/example_goole_twitter";
	}
	...
	@RequestMapping("/sparklr/photos.do")
	public String photos(Model model) throws Exception {
		model.addAttribute("photoIds", sparklrService.getSparklrPhotoIds());
		return "/jsp/standard/security/oauth1/consumer/sparklr";
	}

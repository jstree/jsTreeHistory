...
catch(Exception ex)
{
	...
	System.out.println("HttpService delete error");
}
finally
{
    ...
    out.print("</root>");
    System.out.println("HttpService delete row=" + iResult);
	System.out.println("HttpService delete sql=" + sql);
	System.out.println("HttpService delete execution time: " + (System.currentTimeMillis() - startTime));
	System.out.println("-----------------------------------------------------------------------");
}
%>
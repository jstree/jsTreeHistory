...
<caption>행사접수관리 등록</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">신청자<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"  ><c:out value='${eventManageVO.eventTemp6}'/></td>
    <th width="20%" height="23" class="required_text"  scope="row">소속<img src="/images/egovframework/com/uss/ion/evt/icon/no_required.gif" width="15" height="15" alt=""></th>          
    <td width="30%"  ><c:out value='${eventManageVO.eventTemp7}'/></td>
  </tr> 
  <tr> 
    <th width="20%" height="23" class="required_text"  scope="row">행사구분<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
    <td width="30%" ><c:out value='${eventManageVO.eventTemp3}'/></td>
    <th width="20%" height="23" class="required_text"  scope="row">행사명<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
    <td width="30%" ><c:out value='${eventManageVO.eventNm}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사목적<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%"  colspan="3"><c:out value='${eventManageVO.eventPurps}'/></td>    
  </tr> 

  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사기간<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사주최<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%"  colspan="3"><c:out value='${eventManageVO.eventAuspcInsttNm}'/></td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사주관<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%"  colspan="3"><c:out value='${eventManageVO.eventMngtInsttNm}'/></td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사장소<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%"  colspan="3"><c:out value='${eventManageVO.eventPlace}'/></td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">참조URL<img src="/images/egovframework/com/uss/ion/evt/icon/no_required.gif" width="15" height="15" alt=""></th>          
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사내용<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%"  colspan="3">
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">참가비용<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%"  colspan="3"> 
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">정원<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%"   colspan="3"><c:out value='${eventManageVO.garden}'/>
    </td>    
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사접수기간<img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%"   colspan="3">
...
<!-- 결재권자 지정 Include -->
<jsp:include page="/WEB-INF/jsp/egovframework/example/egovframework/com/uss/ion/ism/EgovInfrmlSanctnRegist.jsp" flush="true"/> 
<!-- //결재권자 지정 Include -->

package standard.mvc.staticPage.mobileApi.controller;
...
import standard.mvc.dao.hibernate.SearchSupport;
	...
	/**
	 * 바로보드 소개 > 모바일 API 디바이스 메뉴에 해당하는 컨트롤러
	 * 
	 * @author 유정우
	 * @since 2014.07.06
	 */
	...
	@Controller
	@RequestMapping(value = "/community/introduce/11mobile-api")
	public class MobileApiController extends GenericAbstractController implements
